...
if ( ! function_exists( 'js_composer_bridge_admin' ) ) {
    ...
    function pixflow_js_composer_scripts_admin() {
        ...
        {
            {
                ...
                wp_enqueue_style('rtl-inner-customizer', PIXFLOW_THEME_LIB_URI . '/assets/css/rtl-inner-customizer.css');
            }
        }
        ...
        {
            //Register RTL inner Style
            wp_enqueue_style('rtl-dashboard', PIXFLOW_THEME_LIB_URI . '/assets/css/rtl-dashboard.css');
        }
        ...
        {
            //Register RTL Style
            wp_enqueue_style('rtl-style', pixflow_path_combine(PIXFLOW_THEME_URI,'rtl-customizer.css'),array(),PIXFLOW_THEME_VERSION);
        }
...
//add icon to vc_wp_text,vc_raw_js and vc_raw_html

$rawHtml = array(
    "name" => "Raw HTML",
    'show_settings_on_create' => false,
    "icon" => PIXFLOW_THEME_LIB_URI."/assets/img/vcicons/shortcode-icons.png?x=7|y=-2858",
    "weight" => '-9',
    "category" => esc_attr__('Container','massive-dynamic'),
);

vc_map_update('vc_raw_html', $rawHtml);
...
vc_map_update('vc_wp_text', $vcWpText);
...
vc_map(
    array(
        ...
        "params" => array(
            ...
            array(
                "type"        => "md_vc_description",
                "param_name"  => "md_google_map_key_description",
                "admin_label" => false,
                "value"       => wp_kses(__("To read about google map API key, please visit <a href='https://developers.google.com/maps/documentation/javascript/get-api-key'>here </a>",'massive-dynamic'),array("a"=>array('href' => array()))),
            ),
...
function pixflow_slider_param(){
    ...
    for($i=1; $i<=(int)$slider_num ; $i++){
        ...
        $param[] =array(
                ...
                "edit_field_class" => $filedClass."glue slide_btn1_".$i.'_dependency',
                "heading"     => esc_attr__("Text Color", 'massive-dynamic'),
                "param_name"  => "slide_btn1_text_hover_color".$i,
                "group"       => esc_attr__("Slide ",'massive-dynamic').$i,
                "admin_label" => false,
                "description" => esc_attr__("Enter optional button hover's color", 'massive-dynamic'),
                "dependency" => array(
        ...
        $param[] =array(
            ...
            "edit_field_class" => $filedClass."glue slide_btn2_".$i.'_dependency',
            "heading"     => esc_attr__("Text Color", 'massive-dynamic'),
            "param_name"  => "slide_btn2_hover_color".$i,
            "group"       => esc_attr__("Slide ",'massive-dynamic').$i,
            "admin_label" => false,
            "description" => esc_attr__("Enter optional button hover's color", 'massive-dynamic'),
            "dependency" => array(
...
vc_map( array(
    ...
    "base"                    => "md_quote",
    "icon"                    => PIXFLOW_THEME_LIB_URI."/assets/img/vcicons/shortcode-icons.png?x=8|y=-3352",
    "show_settings_on_create" => false,
    "category"                => 'Business',
...
vc_map( array(
    ...
    "icon"                    => PIXFLOW_THEME_LIB_URI."/assets/img/vcicons/shortcode-icons.png?x=8|y=-2918",
    "show_settings_on_create" => false,
    "category"                => 'Business',
...
vc_map(
    ...
    array(
        ...
        'icon'                      => PIXFLOW_THEME_LIB_URI."//assets/img/vcicons/shortcode-icons.png?x=8|y=-3302",
        "show_settings_on_create"   => false,
        "category"                  => esc_attr__('Business','massive-dynamic'),
        "allowed_container_element" => 'vc_row',
...
vc_map(
    array(
        ...
        "category" => esc_html__('Business','massive-dynamic'),
        "icon" => PIXFLOW_THEME_LIB_URI."/assets/img/vcicons/shortcode-icons.png?x=6|y=-3190",
        "show_settings_on_create" => false,
        "allowed_container_element" => 'vc_row',
        "params" => array(
...
vc_map(
    array(
        ...
        'icon' => PIXFLOW_THEME_LIB_URI."/assets/img/vcicons/shortcode-icons.png?x=8|y=-2968",
        "show_settings_on_create" => false,
        "category" => esc_attr__('Business','massive-dynamic'),
        "allowed_container_element" => 'vc_row',
        "params" => array(
...
vc_map(
    array(
        ...
        'icon' => PIXFLOW_THEME_LIB_URI."/assets/img/vcicons/shortcode-icons.png?x=8|y=-3520",
        "show_settings_on_create" => false,
        "category" => esc_attr__('Business','massive-dynamic'),
        "params" => array(
            array(
...
vc_map(
    array(
        ...
        'icon' => PIXFLOW_THEME_LIB_URI."/assets/img/vcicons/shortcode-icons.png?x=4|y=-3024",
        "show_settings_on_create" => false,
        "category" => esc_attr__('Business','massive-dynamic'),
        "allowed_container_element" => 'vc_row',
        "params" => array(
...
vc_map(
    array(
        ...
        'icon' => PIXFLOW_THEME_LIB_URI."/assets/img/vcicons/shortcode-icons.png?x=8|y=-3463",
        "show_settings_on_create" => false,
        "category" => esc_attr__('Business','massive-dynamic'),
        "allowed_container_element" => 'vc_row',
        "params" => array(
...
vc_map(
    array(
        ...
        'icon' => PIXFLOW_THEME_LIB_URI."/assets/img/vcicons/shortcode-icons.png?x=8|y=-3409",
        "show_settings_on_create" => false,
        "category" => esc_attr__('Business','massive-dynamic'),
        "params" => array(
...
vc_map(
    array(
        ...
        "base" => "md_iconbox_new",
        "category" => esc_attr__('Business','massive-dynamic'),
        "icon" => PIXFLOW_THEME_LIB_URI."/assets/img/vcicons/shortcode-icons.png?x=6|y=-3134",
        "allowed_container_element" => 'vc_row',
        'show_settings_on_create' => false,
...
vc_map( array(
    ...
    "icon"                    => PIXFLOW_THEME_LIB_URI."/assets/img/vcicons/shortcode-icons.png?x=8|y=-3080",
    "show_settings_on_create" => false,
    "category"                => 'Business',
...
vc_map( array(
    ...
    "base"                    => "md_info_box",
    "icon"                    => PIXFLOW_THEME_LIB_URI."/assets/img/vcicons/shortcode-icons.png?x=8|y=-3244",
    "show_settings_on_create" => false,
    "category"                => 'Business',
...
vc_add_params( 'md_quote', pixflow_addAnimationTab('md_quote') );
vc_add_params( 'md_feature_image', pixflow_addAnimationTab('md_feature_image') );
vc_add_params( 'md_price_box', pixflow_addAnimationTab('md_price_box') );
vc_add_params( 'md_article_box', pixflow_addAnimationTab('md_article_box') );
vc_add_params( 'md_countercard', pixflow_addAnimationTab('md_countercard') );
vc_add_params( 'md_statistic', pixflow_addAnimationTab('md_statistic') );
vc_add_params( 'md_splitBox', pixflow_addAnimationTab('md_splitBox') );
vc_add_params( 'md_iconbox_new', pixflow_addAnimationTab('md_iconbox_new') );
vc_add_params( 'md_process_panel', pixflow_addAnimationTab('md_process_panel') );
vc_add_params( 'md_info_box', pixflow_addAnimationTab('md_info_box') );
...
(function (root, factory) {
  ...
  function _setHelperLayerPosition(helperLayer) {
    if (helperLayer) {
      ...
      helperLayer.setAttribute('style', 'width: ' + (elementPosition.width  + widthHeightPadding)  + 'px; ' +
          'height:' + (elementPosition.height + widthHeightPadding + 13) + 'px; ' +
  ...
  function _showElement(targetElement) {
    ...
    if (oldHelperLayer != null) {
      ...
      /* Massive added */
      $('.wp-full-overlay').append(helperLayer);
      $('.wp-full-overlay').append(referenceLayer);
  ...
  function _addOverlayLayer(targetElm) {
    ...
    /* Massive added */
    $('.wp-full-overlay').append(overlayLayer);
  ...
  function _hintClick(hintElement, item, stepId) {
    ...
    setTimeout( function() {
      $('.introjs-hintReference').css({ transition: 'opacity .4s', opacity: '1' });
    }, 100);
